            ...
            <div className="footer-container">
                <div className="footer-content">
                    ...
                    <div className="footer-brand">
                        <Link to="/" className="footer-logo">VYBE</Link>
                        <p className="footer-tagline">Streetwear made for your vibe.</p>
                    ...
                    <div className="footer-contact" id="contact">
                        ...
                        <div className="contact-items">
                            <a href="mailto:support@vybe.com" className="contact-item">
                            ...
                            <a href="tel:+13235550199" className="contact-item">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#E87D6F" strokeWidth="2">
